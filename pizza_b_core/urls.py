"""
URL configuration for pizza_b_core project.
...
urlpatterns = [
    ...
    path('', include('pizza_b.urls')),
    path('api/schema/', SpectacularAPIView.as_view(), name='schema'),  # генерирует OpenAPI схему JSON
